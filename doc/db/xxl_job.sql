/*
 ...
 Source Server         : 121.5.64.212
 Source Server Type    : MySQL
 Source Server Version : 50650
 Source Host           : 121.5.64.212:3306
...
-- ----------------------------
-- Table structure for xxl_job_bus_group
-- ----------------------------
DROP TABLE IF EXISTS `xxl_job_bus_group`;
CREATE TABLE `xxl_job_bus_group`  (
...
CREATE TABLE `xxl_job_info`  (
  ...
  `bus_id` int(11) NULL DEFAULT NULL COMMENT '业务组id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `xxl_job_log_report` VALUES (1, '2021-02-26 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (2, '2021-02-25 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (3, '2021-02-24 00:00:00', 0, 0, 0, NULL);
