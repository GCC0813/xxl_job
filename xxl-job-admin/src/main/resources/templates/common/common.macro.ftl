<#macro commonStyle>
    ...
    <!-- pace -->
	<link rel="stylesheet" href="${request.contextPath}/static/plugins/layer/layui.css">
	<#-- i18n -->
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "index">active</#if>" ><a href="${request.contextPath}/"><i class="fa fa-circle-o text-red"></i><span>${I18n.job_dashboard_name}</span></a></li>
				<li class="nav-click <#if pageName == "jobinfo">active</#if>" ><a href="${request.contextPath}/jobinfo"><i class="fa fa-circle-o text-orange"></i><span>${I18n.jobinfo_name}</span></a></li>
				...
				<#if Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                    ...
                    <li class="nav-click <#if pageName == "jobbusgroup">active</#if>" ><a href="${request.contextPath}/jobbusgroup"><i class="fa fa-circle-o text-cyan"></i><span>${I18n.jobinfo_businessgroup}</span></a></li>
                    <li class="nav-click <#if pageName == "user">active</#if>" ><a href="${request.contextPath}/user"><i class="fa fa-circle-o text-blue"></i><span>${I18n.user_manage}</span></a></li>
				</#if>
				<li class="nav-click <#if pageName == "help">active</#if>" ><a href="${request.contextPath}/help"><i class="fa fa-circle-o text-purple"></i><span>${I18n.job_help}</span></a></li>
			</ul>
		</section>
		<!-- /.sidebar -->
	</aside>
